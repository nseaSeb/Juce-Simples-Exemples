...
//==============================================================================
class TraduireApplication  : public JUCEApplication
{
public:
    //==============================================================================
    TraduireApplication() 
    {
        ...
        File languageFile(File::getSpecialLocation(File::SpecialLocationType::currentExecutableFile).getChildFile("../../Resources/French.txt"));
...
START_JUCE_APPLICATION (TraduireApplication)
